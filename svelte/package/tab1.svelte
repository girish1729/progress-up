...
<script>import ldBar from 'https://cdn.jsdelivr.net/gh/girish1729/progress-up/backend/public/assets/progressBar/loading-bar.js';
import { afterUpdate } from 'svelte';
import { inputs, totalsize, totalfiles, statsTable, progressBars, errInfos, uploadFileInfos, uploadFileList, errMsg } from './store.js';
...
const uploadOneFile = async (info, idx) => {
...
const printBannedBanner = (file, id, ts, msg) => {
    $errInfos.push({
        file: file,
        id: id,
        meta: '',
